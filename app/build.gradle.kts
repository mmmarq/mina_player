...
android {
    namespace = "br.com.mmmarq1976.mina"
    compileSdk = 34

    defaultConfig {
        applicationId = "br.com.mmmarq1976.mina"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    // Load local.properties for release signing configuration
...
dependencies {
    // Core AndroidX and Play Services
    ...
    // Coil (Image Loading for embedded/local artwork)
